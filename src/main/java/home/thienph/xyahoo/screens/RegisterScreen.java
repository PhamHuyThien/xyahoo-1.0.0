...
import home.thienph.xyahoo.actions.thien_ei;
import home.thienph.xyahoo.actions.thien_ej;
...
extends FormScreen {
    ...
    public static void a(RegisterScreen registerScreen2, String string) {
