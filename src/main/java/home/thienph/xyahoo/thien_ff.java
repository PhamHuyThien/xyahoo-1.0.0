...
public final class thien_ff extends Screen {
   ...
   public final void h() {
      ...
      TextField var6;
      (var6 = new TextField()).setBounds(var3, var4, var2, thien_w.f + 6);
   ...
   public final void b(String var1) {
      ...
      TextField var7;
      (var7 = new TextField()).setBounds(var4, var5, var3, thien_w.f + 6);
      var7.setText(var1);
      var5 += 5 + var7.height;
      thien_ai var11 = new thien_ai(TextConstant.toNewGroup(), var4, var5, thien_w.f);
      var5 += 1 + var11.height;
      TextField var8;
      (var8 = new TextField()).setBounds(var4, var5, var3, thien_w.f + 6);
   ...
   public thien_ff() {
      ...
      UIAction var2;
      (var2 = new UIAction(TextConstant.showHide(), null)).icon = new thien_am(var1);
      ...
      (var2 = new UIAction(TextConstant.changeUserProfile(), null)).icon = new thien_am(var1);
      this.J.addElement(var2);
      ...
      (var2 = new UIAction(TextConstant.otherTools(), null)).icon = new thien_am(var1);
      this.J.addElement(var2);
