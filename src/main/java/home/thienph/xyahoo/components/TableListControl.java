...
public final class TableListControl
    ...
    public final boolean handleKeyInput(int n) {
        ...
        switch (n) {
            ...
            case 15: {
                if (this.selectedColumn >= this.columns - 1 || !this.isValidTablePosition(this.selectedRow, this.selectedColumn + 1))
                    break;
                ++this.selectedColumn;
                bl = false;
                break;
    ...
    public static int getSelectedTableIndex(TableListControl tableListControl2) {
        return tableListControl2.selectedRow * tableListControl2.columns + tableListControl2.selectedColumn;
    }

    public static int getRoomType(TableListControl tableListControl2) {
