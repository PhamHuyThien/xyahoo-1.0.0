...
public final class BigTwoGameScreen extends Screen {
   ...
   public final void showTableList(TableInfo[] var1, int var2) {
      ...
      this.gameMenuItems.addElement(RoomListScreen.z);
   ...
   public final void initializeGameSession(byte var1, String[] var2, long[] var3, int[] var4, String[] var5, int[] var6, Integer[] var7, String var8) {
      ...
      this.playerMenuItems.addElement(RoomListScreen.z);
   ...
   static void adjustScrollPosition(BigTwoGameScreen var0) {
      var0.adjustScrollPosition();
   }

   static TextField getBetTextField() {
      return betTextField;
   }

   static PopupSideElementData getGameMenuData(BigTwoGameScreen var0) {
      return var0.gameMenuData;
   }

   static void setTableListControl(BigTwoGameScreen var0, TableListControl var1) {
      var0.tableListControl = null;
   }

   static PopupSideElementData getPlayerMenuData(BigTwoGameScreen var0) {
      return var0.playerMenuData;
   }

   static PopupSideElementData getContextMenuData(BigTwoGameScreen var0) {
      return var0.contextMenuData;
   }

   static void setContextMenuData(BigTwoGameScreen var0, PopupSideElementData var1) {
      var0.contextMenuData = var1;
   }

   static UIAction getChatAction(BigTwoGameScreen var0) {
      return var0.chatAction;
   }

   static UIAction getSmileyAction(BigTwoGameScreen var0) {
      return var0.smileyAction;
   }

   static UIControlBase getSelectedControl(BigTwoGameScreen var0) {
