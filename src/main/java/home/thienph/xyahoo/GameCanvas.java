         ...
         try {
            switch (gameState) {
               case 0:
                  ...
                  if (thien_ev.a == 35) {
                     thien_di.b().a(screenWidth, screenHeight);
                  }
                  ...
                  break;
               case 1:
                  thien_di.c.a(keyPressedState, keyRepeatedState, lastKeyCode);
            }
         ...
         switch (gameState) {
            case 0:
               ...
               if (!isGameStarted) {
                  ...
                  thien_di.c.a(var1, screenWidth >> 1, (screenHeight + thien_aq.a >> 1) + 3);
