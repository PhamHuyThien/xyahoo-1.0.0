      ...
      if (var1[16]) {
         ...
         if (this.A.c().equals("")) {
            ...
            if (this.C) {
               ...
               thien_a.f(super.h, this.A.c());
            } else if (this.w) {
               thien_a.a((String)(var5 = thien_gp.x), this.x, this.A.c(), 2);
            } else {
               thien_a.a((String)(var5 = thien_ff.y), super.g, this.A.c(), 1);
            }
