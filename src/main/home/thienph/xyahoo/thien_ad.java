...
public final class thien_ad {
    ...
    public thien_ad(String string, thien_ab thien_ab2, thien_ab thien_ab3, thien_ab thien_ab4) {
        this.e = thien_w.b(string, thien_d.j - 30, thien_w.j);
        this.a = thien_ab2;
        this.c = thien_ab4;
        this.b = thien_ab3;
        this.a();
    ...
    private void a() {
        ...
        if (this.l > thien_d.k - 35) {
            this.l = this.k = thien_d.k - 35;
        }
        int n = 0;
        while (n < this.f) {
        ...
        if (this.m > thien_d.j - 15) {
            this.m = thien_d.j - 15;
        }
        this.n = thien_d.k - this.l >> 1;
    ...
    public final void a(Graphics graphics) {
        ...
        thien_an.c(graphics);
        graphics.setColor(0xFFFFFF);
        n2 = thien_d.k - (thien_di.g >> 1) - (thien_w.f >> 1) + (thien_w.a ? 0 : 2);
        if (this.a != null) {
        ...
        if (this.c != null) {
            thien_w.a(thien_w.d).a(this.c.a, thien_d.j - 4, n2, 1, graphics, thien_w.j, thien_w.f);
        }
    }
}
